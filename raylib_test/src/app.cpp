...
#include "https.h"
	...
	std::string imgPath = result.isDay == true ? "/Weather/res/img/day/" : "/Weather/res/img/night/";
	...
	app.createElement(std::to_string((int)result.tempC) + "°c", 0, 90, { (float)textStartX + 400,50.f });
